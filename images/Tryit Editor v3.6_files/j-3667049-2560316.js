...
(function(){
    ...
    (function() {
    var p = "3667049", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3667049||'',
    guid:window.ftGUID_3667049||'',
    confID:window.ftConfID_3667049||'0',
    ftReturn: window.ftReturn_3667049||'',
    keyword:window.ftKeyword_3667049||'',
    ftId:window.ftId_3667049||'',
    ftImpId:window.ftImp3667049 && window.ftImp3667049.impID || '',
    campaignID: '104109',
    cID:'100890',
    pID:'3667049',
    creativeID:'2560316',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=104109&sid=3155&plc=3667049&num=&adid=&advid=&adsrv=29&btreg=3667049&btadsrv=flashtalking&crt=2560316&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/104109;3667049;2560316;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/creativecloud/plans.html?sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?133879711-3667049;2560316;',
    centreAd: true,
    width:728,
    height:90,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/366/3667049/2560316/image/2560316.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/104109;3667049;202;pixel;Quantcast;QuantcastFY19CCLALFullFunnelValueAddUSVAWB728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/104109;3667049;2560316;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/creativecloud/plans.html?sdid=GZKZY1B7&mv=display',
    divID:'ftdiv3667049',
    altimgID:'ftalt3667049',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3667049 && parseInt(window.ftImp3667049.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3667049') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3667049'),
    pageVisible: 'maybe',
...
//TA_1 min
//ftMinified
(function(b){var c=window["ftImp"+b.pID]&&window["ftImp"+b.pID].privacy;c&&"x"!==c||((new Image).src=b.replaceMacros("ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2035&ta_partner_did=[GUID]&ta_format=png",!0),"undefined"==typeof window.ftD9ResponseRegister&&(window.ftD9ResponseRegister=[]),window.ftD9ResponseRegister.push({getD9Id:function(){return window.ft_d9ID||""},d9Response:function(b){var a="";try{a=b.DeviceID[0]}catch(d){}"timeout"!=a&&a?this.getD9Id()||(window.ft_d9ID=a||"",this.getD9Id()&&(this.d9Response=function(){})):a="";a&&((new Image).src="ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2176&ta_partner_did="+a+"&ta_format=png")}}))}(ft3667049));
