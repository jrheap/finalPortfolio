...
a:{try{var f=null!=g.querySelector('div[id="kt_player"][hiegth]');break a}catch(m){}f=void 0}e(21,14,f);a:{try{var k=b.top==b&&null!=b.document.querySelector('div[id="asu"][class="kk"]');break a}catch(m){}k=void 0}e(22,15,k);a:{try{var h=g.querySelector('object[data*="/VPAIDFlash.swf"]')&&g.querySelector('object[id*="vpaid_video_flash_tester_el"]')&&g.querySelector('div[id*="desktopSubModal"]');break a}catch(m){}h=void 0}e(25,16,h);return{f:c,s:d}}catch(m){return null}}function X(){function b(b){if(null==
b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},f=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var e=Math.ceil((b.length/4+2)/16),g=Array(e),l=0;l<e;l++){g[l]=Array(16);for(var n=0;16>n;n++)g[l][n]=b.charCodeAt(64*l+4*n)<<24|b.charCodeAt(64*l+4*n+1)<<16|b.charCodeAt(64*l+4*n+2)<<8|b.charCodeAt(64*l+4*n+3)}g[e-1][14]=8*(b.length-1)/Math.pow(2,32);g[e-1][14]=Math.floor(g[e-
1][14]);g[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;n=4023233417;var p=2562383102,v=271733878,D=3285377520,z=Array(80);for(l=0;l<e;l++){for(var q=0;16>q;q++)z[q]=g[l][q];for(q=16;80>q;q++)z[q]=c(z[q-3]^z[q-8]^z[q-14]^z[q-16],1);var C=b;var t=n;var x=p;var y=v;var A=D;for(q=0;80>q;q++){var r=Math.floor(q/20),E=c(C,5);a:{switch(r){case 0:var u=t&x^~t&y;break a;case 1:u=t^x^y;break a;case 2:u=t&x^t&y^x&y;break a;case 3:u=t^x^y;break a}u=void 0}r=E+u+A+f[r]+z[q]&4294967295;A=y;y=x;x=c(t,30);t=C;
C=r}b=b+C&4294967295;n=n+t&4294967295;p=p+x&4294967295;v=v+y&4294967295;D=D+A&4294967295}return d(b)+d(n)+d(p)+d(v)+d(D)}function c(){try{return!!window.sessionStorage}catch(f){return!0}}function d(){try{return!!window.localStorage}catch(f){return!0}}function e(){try{var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",
2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}}catch(h){}return null}try{var g=[];g.push(["lang",navigator.language||navigator.browserLanguage]);g.push(["tz",(new Date).getTimezoneOffset()]);g.push(["hss",c()?"1":"0"]);g.push(["hls",d()?"1":"0"]);g.push(["odb",typeof window.openDatabase||""]);g.push(["cpu",navigator.cpuClass||""]);g.push(["pf",navigator.platform||""]);g.push(["dnt",navigator.doNotTrack||""]);g.push(["canv",e()]);return b(g.join("=!!!="))}catch(f){return null}}
this.createRequest=function(){var b=!1,c=window,d=0,e=!1;try{for(dv_i=0;10>=dv_i;dv_i++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,d++,b=!0;else{b=!1;break}else{0==dv_i&&(b=!0);break}}catch(m){b=!1}a:{try{var g=c.$sf;break a}catch(m){}g=void 0}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(I(b)){a:{try{var f=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(m){}f=void 0}if(f&&!I(f)&&0==
f.indexOf(b)){b=f;var k=!0}}e=!0}if(!window._dv_win.bsredirect5ScriptsInternal||!window._dv_win.bsredirect5Processed||0==window._dv_win.bsredirect5ScriptsInternal.length)return{isSev1:!1,url:null};this.dv_script_obj=f=Q();f=this.dv_script=f.script;var h=f.src.replace(/^.+?callback=(.+?)(&|$)/,"$1");if(h&&(this.redirect=eval(h+"()"))&&!this.redirect.done){this.redirect.done=!0;if(P(this.redirect))return{isSev1:!0};c=L(this.redirect,b,c,d,e,f&&f.parentElement&&f.parentElement.tagName&&"HEAD"===f.parentElement.tagName,
f,k,g);c+="&"+this.getVersionParamName()+"="+this.getVersion();return{isSev1:!1,url:c}}};this.isApplicable=function(){return!0};this.onFailure=function(){};this.sendRequest=function(b){dv_sendRequest(b);try{var c=R(this.dv_script_obj&&this.dv_script_obj.injScripts),d=K("about:blank");d.id=d.name;var e=d.id.replace("iframe_","");d.setAttribute&&d.setAttribute("data-dv-frm",e);G(d,this.dv_script);if(this.dv_script){var g=this.dv_script;a:{b=null;try{if(b=d.contentWindow){var f=b;break a}}catch(m){}try{if(b=
window._dv_win.frames&&window._dv_win.frames[d.name]){f=b;break a}}catch(m){}f=null}g.dvFrmWin=f}var k=S(d);if(k)k.open(),k.write(c);else{try{document.domain=document.domain}catch(m){}var h=encodeURIComponent(c.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));d.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+h+"');})()"}}catch(m){c=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",dv_SendErrorImp(c+
"/verifyc.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(m)}])}return!0};window.debugScript&&(!window.minDebugVersion||10>=window.minDebugVersion)&&(window.DvVerify=L,window.createRequest=this.createRequest);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"74"}};
